...
class AgentInsight(BaseModel):
    ...
    key_findings: Optional[List[str]] = Field(
        default=None, description="Bullet points of key findings"
    )
    evidence: Optional[Dict[str, Any]] = Field(
        default=None, description="Supporting data from tool calls"
    )
...
class AgentResponse(BaseModel):
    ...
    content: Union[AgentInsight, str] = Field(
        ...,
        description="The insight generated by the agent (AgentInsight for success, empty string for errors)",
    )
    ...
    def create_success(
        cls,
        content: Union[AgentInsight, str],
        agent_name: str,
        agent_category: str,
        **kwargs: Any,
    ) -> "AgentResponse":
